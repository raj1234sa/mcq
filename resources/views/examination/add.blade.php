@extends('layout.main')
@section('page-title', (isset($post_data) ? 'Edit Exam' : 'Add Exam'))
@section('page-header', (isset($post_data) ? 'Edit Exam' : 'Add Exam'))
@section('page-content')
    <div class="card">
        <form action="/exam-save-form" method="post" class="row no-gutters card-body">
            @csrf
